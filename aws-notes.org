...
* Kinesis
Streaming real life data
Producer: crates data
Stream Store: stores / analyses data
Consumer: consumes data
** types
*** Data stream
Captures, process, store data streams real-time
*** Data Firehose
Use for moving data from A to B
S3 || RedShift
*** Data Analytics
Analyze streaming data in real-time with SQL/Java
*** Video Stream
Capture, process, store video stream
** shards
1 shard =
write: 1MB/s || 1000 records/s
read: 2MB/S
* Lambda
On demand
Virtual functions
...
YAML configuration
Genrate CloudFormation from YAML file
...
X-Ray Daemon on instance will send data to X-Ray CLI
You can see visualisation / data in the aws console
** Daemon
Runs on EC2 that runs app
EC2 needs role policy that enables access to X-ray
** integrations
- EC2
- Lambda
